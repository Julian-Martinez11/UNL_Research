...
## Number of leptons EFT Coefficients:
...
Combines all of the different kinematic effects mentioned and cuts in one single notebook and outputs a list of the coefficients of interest (based on the frequency we choose).
